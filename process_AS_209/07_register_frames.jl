...
function register_frames(frames, template_psf, rotator_mode; sizes=(200, 190, 180, 170))
    ...
    for frame in frames
        coarse_center = argquantile(frame.data, 0.999)
...
function register_epochs()
    ...
    template_psf = load(joinpath(sequence_obslog.paths.sequences_folder, "HR_8799_template_psf_cored.fits"))
